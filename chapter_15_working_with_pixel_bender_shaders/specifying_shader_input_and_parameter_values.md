## Specifying shader input and parameter values {#specifying-shader-input-and-parameter-values}
...
shader = new Shader(loader.data); texture = new Sprite(); addChild(texture);
